/*===========================================================================
 *  dial.c — Tarcza analogowa VFO (port z dial.cpp JF3HZB)
 *  ESP-IDF 5.x — usunieto Arduino, poprawiono typy
 *===========================================================================*/
...
/*--- Forward declarations (wymagane w C, zbedne w C++) ---*/
static void Sel_font12(void);
static void Sel_font14(void);
static void Sel_font16(void);
static void dot(float x, float y);




/*--- Definicje zmiennych parametrow tarczy ---*/
char f_dispmode     = 0;
char f_main_outside = 0;
char f_FONT         = 0;
char f_rev          = 0;
char f_maintick1    = 1;
char f_maintick5    = 1;
...
char f_subtick10    = 1;
char f_subnum       = 1;
int freq_tick_main  = 10000;
int D_height        = 80;
int D_R             = 160;
int Dial_space      = 40;
int tick_pitch_main = 50;
int tick_pitch      = 60;
int tick_width      = 1;
int tick_main1      = 4;
int tick_main5      = 9;
...
int DP_width        = 1;
int DP_pos          = 12;
unsigned long cl_BG        = 0x000000;
unsigned long cl_POINTER   = 0xFF0000;
unsigned long cl_TICK_main = 0x00FF00;
unsigned long cl_NUM_main  = 0xFFFFFF;
unsigned long cl_TICK      = 0x00FFFF;
unsigned long cl_NUM       = 0xFFFFFF;
unsigned long cl_DIAL_BG   = 0x000000;
...
/* druga wersja dot() usunieta */


/*===========================================================================
 *  Wrappers — publiczne API zgodne z dial.h
 *===========================================================================*/
void dial_init(void)
{
    init_Dial();
